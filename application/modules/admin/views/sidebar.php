<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/pahlawan"><i class="mdi mdi-gauge"></i><span class="hide-menu">Pahlawan</span></a>
        </li>
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/favorite"><i class="mdi mdi-gauge"></i><span class="hide-menu">Favorite</span></a>
        </li>
        <li>
